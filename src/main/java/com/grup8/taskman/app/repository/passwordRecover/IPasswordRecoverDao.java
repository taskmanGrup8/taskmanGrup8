...
public interface IPasswordRecoverDao extends CrudRepository<PasswordRecover, Long>{
	...
	/**
	 * Funció que busca a la base de dades la llista de PasswordRecover que el seu camp link sigui igual al passat per paràmetre
	 * @param link Link que volem cercar
	 * @return Retorna un Optional amb la llista trobada.
	 */
